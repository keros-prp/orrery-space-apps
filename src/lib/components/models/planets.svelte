...
<script lang="ts">
  ...
  const marte = new CuerpoCeleste("Mars", 1.52371243, 0.00000097, 0.09336511, 0.00009149, 1.85181869, -0.00724757, -4.56813164, 19140.29934243, -23.91744784, 0.45223625, 49.71320984, -0.26852431, 1.881, textureMars);
  ...
  const neptuno = new CuerpoCeleste("Neptune", 30.06952752, 0.00006447, 0.00895439, 0.00000818, 1.77005520, 0.00022400, 304.22289287, 218.46515314, 46.68158724, 0.01009938, 131.78635853, -0.00606302, 164.8, textureNeptune);
  const pluton = new CuerpoCeleste("Pluto", 39.76117, 0, 2.502879951216484e-01, 0, 1.732559807118311e+01, 0, 0, 0, 1.151409620637363E+02, 0, 1.104336423551854E+02, 0, 248.1, texturePluto);
  ...
  useTask((delta) => {
    ...
    for (let planeta of planetas) {
      ...
      planetMetaInfo!.push({name: planeta.name, pos: new Vector3(pos[0], pos[1], pos[2]), texture:planeta.texture});
